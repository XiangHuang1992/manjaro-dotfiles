...
" 允许vim 加载 .ycm_extra_conf.py文件，不再提示
...
" 文件管理器nerdtree {{{
" 过滤文件和文件夹
let NERDTreeIgnore = ['\.vscode' , '__pycache__', '\.pyc$', '\.o$', '\.so$', '\.a$', '\.swp', '*\.swp', '\.swo', '\.swn', '\.swh', '\.swm', '\.swl', '\.swk', '\.sw*$', '[a-zA-Z]*egg[a-zA-Z]*', '.DS_Store']
...
let g:rg_command = '
            ...
            \ -g "*.{js,json,php,md,styl,jade,html,config,vim,py,fish,cpp,c,go,hs,rb,conf,local,production,yml}"
